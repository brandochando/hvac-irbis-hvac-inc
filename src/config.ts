...
// ─── Brand Identity ───────────────────────────────────────────────────────────
export const BRAND_NAME       = "Irbis HVAC";          // e.g. "AirPro"
export const BRAND_FULL_NAME  = "Irbis HVAC Inc.";           // e.g. "AirPro Heating & Air Conditioning"
export const BRAND_LEGAL_NAME = "Irbis HVAC Inc.";          // e.g. "AirPro Heating & Air Conditioning, Inc."
...
export const BRAND_INITIALS   = "IHI";             // e.g. "AP" — used in decorative elements

// ─── Contact ──────────────────────────────────────────────────────────────────
export const PHONE_LABEL  = "(408) 419-1365";   // e.g. "(408) 898-6999"
export const PHONE_TEL    = "tel:14084191365";  // e.g. "tel:14088986999"
export const BRAND_EMAIL  = "accounting@irbishvac.com";                    // e.g. "info@airpro.com"
export const BRAND_ADDRESS = "2210 Lundy Ave, San Jose, CA 95131";                 // e.g. "1593 Trieste Way, San Jose, CA 95122"

// ─── Social Proof ─────────────────────────────────────────────────────────────
export const GOOGLE_RATING  = "4.9";   // e.g. "5.0"
export const GOOGLE_REVIEWS = "1451";  // e.g. "47"

// ─── Colors (CSS hex values) ──────────────────────────────────────────────────
export const PRIMARY_COLOR   = "#1A8FDB";   // brand accent — buttons, links, gold
...
export const SEO_TITLE       = "Irbis HVAC Inc. — San Jose HVAC";
export const SEO_DESCRIPTION = "Irbis HVAC Inc. — San Jose's trusted HVAC professionals. Professional HVAC Service & Repair in San Jose.";
...
export const HERO_CTA_SECONDARY = "Call 408) 419-1365";   // patched to PHONE_LABEL
export const HERO_SIDE_RAIL_TEXT = "Serving Santa Clara County";
export const HERO_IMG_ALT       = "Irbis HVAC Inc. technician servicing a residential HVAC system in San Jose";
...
export const TRUST_PILLARS = [
  ...
  {
    num: "04",
    eyebrow: "The Irbis HVAC Promise",
...
export const TESTIMONIALS = [
  ...
  {
    quote: "I've used several HVAC companies over the years, but Irbis HVAC is by far the best. New system installed, whole process was smooth from start to finish. Clean work, fair price.",
    author: "Jennifer L.",
    role: "Google Review · 5★",
  },
  {
...
export const FAQ_ITEMS = [
  {
    ...
    a: `Yes — Irbis HVAC Inc. has been proudly serving the area for years. Most appointments are booked the same week you call, and our service call department is open Monday through Friday, 8:00 AM – 5:00 PM.`,
  },
  {
    q: "Are you licensed, bonded, and insured?",
    a: `Absolutely. Irbis HVAC Inc. is fully licensed, bonded, and insured. Every technician on our team is trained, professional, and treats your home with respect.`,
  },
  {
